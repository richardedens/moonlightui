...
options.data=JSON.stringify(options.data),options.contentType="application/json; charset=utf-8",options.dataType="json",options.async=!1,$.ajax(options).done(function(data){done(data)}).fail(function(){error()})}}),window.$ml=window.moonlightui=$.noConflict()});